This is a new Shared Collection (integration settgings) to be use in Cenit, named cenit-collection-desk.
...
Or install it yourself as:
    ...
    $ gem install cenit-collection-desk
...
% tree
.
├── cenit-collection-cenit-collection-desk.gemspec
├── Gemfile
├── .gitignore
├── .rspec
├── README.md
    ...
    └── cenit
        └── collection
            └── cenit-collection-desk
                 ...
                 └── build.rb
                 └── version.rb
            └── cenit-collection-desk.rb
└── spec
    └── cenit
        └── collection
            └── cenit-collection-desk_spec.rb
    └── spec_helper.rb
    └── support
        └── samples
```
...
1. Fork it ( https://github.com/[my-github-username]/cenit-collection-desk/fork )
